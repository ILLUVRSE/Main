...
async function tryOpenAIChat(base: string, prompt: string, model?: string, temperature?: number, max_tokens?: number) {
...
async function tryGeneratePaths(base: string, prompt: string, model?: string, temperature?: number, max_tokens?: number) {
 ...
 */
export async function localPlan(prompt: string, memory: string[] = [], opts: { model?: string; temperature?: number; max_tokens?: number } = {}): Promise<Plan> {
