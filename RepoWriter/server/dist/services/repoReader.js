...
function ensureRepoPath(candidate) {
...
export async function readFileRepo(relPath) {
 ...
 */
export async function readFileSample(relPath, maxBytes = 2000) {
    const abs = ensureRepoPath(relPath);
    try {
 ...
 */
export async function listRepoFiles(pattern = "**/*.*", maxResults = 1000) {
