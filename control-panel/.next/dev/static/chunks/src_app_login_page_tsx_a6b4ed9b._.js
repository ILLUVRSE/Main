...
function LoginPage() {
    ...
    async function submit(e) {
        ...
        try {
            ...
            if (resp.ok) {
                __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$js$2d$cookie$2f$dist$2f$js$2e$cookie$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["default"].set("commandpad_token", "1", {
                    expires: 1 / 24
                }); // 1 hour
                router.push("/");
            } else {
            ...
            setErr(e_0?.message || "network error");
        }
    }
...
_s(LoginPage, "xc0Nvc+P/uCCh6hjBXelrfN1mGk=", false, function() {
    return [
